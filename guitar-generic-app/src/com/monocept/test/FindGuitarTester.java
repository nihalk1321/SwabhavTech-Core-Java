...
public class FindGuitarTester {
	...
	public static void main(String[] args) {
		...
		GuitarSpec whatNihalLikes = new GuitarSpec(Builder.PRS, "Dave Navarro Signature", Type.ELECTRIC, Wood.MAHOGANY,
				Wood.MAPLE);
		List<Guitar> matchingGuitars = inventory.search(whatNihalLikes);
		if (!matchingGuitars.isEmpty()) {
			System.out.println("Nihal, you might like these guitars:");
			...
			System.out.println("Sorry, Nihal, we have nothing for you.");
		}
	}
